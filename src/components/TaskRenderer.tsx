...
const TaskRenderer = ({task, onTaskAttempt}: TaskRendererProps): React.ReactElement => {
    ...
    return (
        <Card style={{ minWidth: '18rem', margin: '20px' }}>
            <Card.Body>
                <Card.Title>{task.getTitle}</Card.Title>
                <Card.Text>
                    <MathContainer>
                        ...
                        <AnswerInput ref={textInput} value={userAnswer} onChange={onAnswerChange}></AnswerInput>
                    </MathContainer>
                </Card.Text>
            </Card.Body>
        </Card>
